    ...
    <section class="text-gray-600 body-font relative">
        <div class="container p-3 mx-auto">
            <div class="flex flex-col text-center w-full my-8">
                <p class="w-full lg:w-2/3 mx-auto leading-relaxed text-2xl">Carga de las ordenes de compra</p>
            </div>
            ...
            <div class="mx-auto p-4 sm:w-1/2 w-full">
                ...
                <div class="grid place-content-center border-2 border-gray-200 px-4 py-6 rounded-lg">
                    <div class="">
                        ...
                        <form wire:submit.prevent="importarUsuariosPrueba" enctype='multipart/form-data'>
                            @method('POST')
                            @csrf
                            ...
                            <div class="grid place-content-center justify-center">
                                ...
                                <div wire:loading.delay.long class="my-4">
                                    <button disabled type="button"
                                        class="text-centerinline-flex items-center px-4 py-2 border border-transparent text-base leading-6 font-medium rounded-md
