...
return [
    ...
    */
    ...
    'per_page_options' => [3,10, 30, 50, 100],
    ...
    */
    ...
    'default_classes' => [
        'tr' => 'my-2',
        'row' => [
            'even' => 'h-12 px-0 divide-x divide-gray-100 text-sm text-gray-900 bg-gray-50',
            'odd' =>  'h-12 px-0 divide-x divide-gray-100 text-sm text-gray-900 bg-gray-200',
            'selected' => 'divide-x divide-gray-100 text-md text-gray-900 bg-yellow-50',
        ],
        'cell' => 'whitespace-no-wrap text-md text-black px-0 py-2',
    ],
